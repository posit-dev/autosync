...
#'
#' Implements the `$edit()` method on the `autosync_doc` handle returned by
...
#' caveats live on [sync_client()].
#'
#' @param doc An `autosync_doc` handle backed by an active connection.
